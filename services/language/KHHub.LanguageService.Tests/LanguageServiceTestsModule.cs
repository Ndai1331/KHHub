...
using KHHub.LanguageService.Data;
using Volo.Abp;
...
namespace KHHub.LanguageService.Tests;

/* This project has a dotnet project reference to the KHHub.LanguageService project,
 * but it does not have a module dependency to the KHHubLanguageServiceModule module class.
 * Because, KHHubLanguageServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubLanguageServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubLanguageServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubLanguageServiceModule))]
