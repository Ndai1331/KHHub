...
using Volo.Abp.LanguageManagement.EntityFrameworkCore;
using KHHub.LanguageService.HealthChecks;
...
public class KHHubLanguageServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<KHHubLanguageServiceContractsModule>(
                    Path.Combine(
                        ...
                        string.Format(
                            "..{0}KHHub.LanguageService.Contracts",
        ...
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            options.FileSets.AddEmbedded<KHHubLanguageServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(KHHubLanguageServiceModule).Assembly, opts =>
                {
