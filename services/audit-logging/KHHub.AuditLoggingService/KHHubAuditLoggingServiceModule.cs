...
using KHHub.AuditLoggingService.HealthChecks;
using Prometheus;
...
public class KHHubAuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<KHHubAuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(KHHubAuditLoggingServiceModule).Assembly, opts =>
                {
