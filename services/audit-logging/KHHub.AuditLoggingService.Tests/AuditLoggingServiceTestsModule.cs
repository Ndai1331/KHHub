...
using KHHub.AuditLoggingService.Data;
using Volo.Abp;
...
namespace KHHub.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the KHHub.AuditLoggingService project,
 * but it does not have a module dependency to the KHHubAuditLoggingServiceModule module class.
 * Because, KHHubAuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubAuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubAuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubAuditLoggingServiceModule))]
