...
using KHHub.IdentityService.Data;
using Volo.Abp;
...
namespace KHHub.IdentityService.Tests;

/* This project has a dotnet project reference to the KHHub.IdentityService project,
 * but it does not have a module dependency to the KHHubIdentityServiceModule module class.
 * Because, KHHubIdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubIdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubIdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubIdentityServiceModule))]
