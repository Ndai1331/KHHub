...
using KHHub.AdministrationService.HealthChecks;
...
public class KHHubAdministrationServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<KHHubAdministrationServiceModule>();
        });
    }
        ...
        Configure<AbpDbContextOptions>(options =>
        {
            ...
            options.Configure<BlobStoringDbContext>(c =>
            {
                c.UseNpgsql(b =>
                {
                    ...
                    b.MigrationsAssembly(typeof(KHHubAdministrationServiceModule).Assembly.GetName().Name);
                });
            });
        });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(KHHubAdministrationServiceModule).Assembly, opts =>
                {
