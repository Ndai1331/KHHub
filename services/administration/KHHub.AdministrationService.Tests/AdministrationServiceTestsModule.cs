...
using KHHub.AdministrationService.Data;
using Volo.Abp;
...
namespace KHHub.AdministrationService.Tests;

/* This project has a dotnet project reference to the KHHub.AdministrationService project,
 * but it does not have a module dependency to the KHHubAdministrationServiceModule module class.
 * Because, KHHubAdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubAdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubAdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubAdministrationServiceModule))]
