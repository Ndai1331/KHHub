...
using KHHub.AIManagementService.Data;
using Volo.Abp;
...
namespace KHHub.AIManagementService.Tests;

/* This project has a dotnet project reference to the KHHub.AIManagementService project,
 * but it does not have a module dependency to the KHHubAIManagementServiceModule module class.
 * Because, KHHubAIManagementServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubAIManagementServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubAIManagementServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubAIManagementServiceModule))]
