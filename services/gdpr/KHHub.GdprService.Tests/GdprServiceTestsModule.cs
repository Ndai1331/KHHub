...
namespace KHHub.GdprService.Tests;

/* This project has a dotnet project reference to the KHHub.GdprService project,
 * but it does not have a module dependency to the KHHubGdprServiceModule module class.
 * Because, KHHubGdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubGdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubGdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubGdprServiceModule))]
