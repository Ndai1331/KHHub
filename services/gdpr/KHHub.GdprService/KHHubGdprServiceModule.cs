...
using KHHub.GdprService.HealthChecks;
...
public class KHHubGdprServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<KHHubGdprServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(KHHubGdprServiceModule).Assembly, opts =>
                {
