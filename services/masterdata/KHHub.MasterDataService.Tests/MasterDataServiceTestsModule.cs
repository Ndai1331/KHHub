...
/* This project has a dotnet project reference to the KHHub.MasterDataService project,
 * but it does not have a module dependency to the KHHubMasterDataServiceModule module class.
 * Because, KHHubMasterDataServiceModule has configurations proper for development and production
 ...
 *
 * For example, KHHubMasterDataServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change KHHubMasterDataServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(KHHubMasterDataServiceModule))]
public class MasterDataServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<MasterDataServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // MasterDataServiceDbContext ()
        new MasterDataServiceDbContext(
            new DbContextOptionsBuilder<MasterDataServiceDbContext>().UseSqlite(connection).Options
