...
```bash
abp generate-proxy -t csharp -url http://localhost:44381/ -m masterdata --without-contracts
```
...
```bash
abp generate-proxy -t ng -url http://localhost:44381/ -m masterdata
```