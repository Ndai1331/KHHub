...
public abstract class EfCoreJobCategoryRepositoryBase : EfCoreRepository<MasterDataServiceDbContext, JobCategory, Guid>
{
    public EfCoreJobCategoryRepositoryBase(IDbContextProvider<MasterDataServiceDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
    ...
    public virtual async Task<List<JobCategory>> GetListAsync(string? filterText = null, string? name = null, string? slug = null, string? description = null, string? icon = null, string? color = null, Guid? parentId = null, int? displayOrderMin = null, int? displayOrderMax = null, bool? isActive = null, string? sorting = null, int maxResultCount = int.MaxValue, int skipCount = 0, CancellationToken cancellationToken = default)
    {
        ...
        query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? JobCategoryConsts.GetDefaultSorting(false) : sorting);
    ...
    protected virtual IQueryable<JobCategory> ApplyFilter(IQueryable<JobCategory> query, string? filterText = null, string? name = null, string? slug = null, string? description = null, string? icon = null, string? color = null, Guid? parentId = null, int? displayOrderMin = null, int? displayOrderMax = null, bool? isActive = null)
    {
