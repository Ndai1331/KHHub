...
public abstract class EfCoreEntityFileRepositoryBase : EfCoreRepository<MasterDataServiceDbContext, EntityFile, Guid>
{
    ...
    protected virtual IQueryable<EntityFileWithNavigationProperties> ApplyFilter(IQueryable<EntityFileWithNavigationProperties> query, string? filterText, string? entityType = null, Guid? entityId = null, string? collection = null, int? sortOrderMin = null, int? sortOrderMax = null, bool? isPrimary = null, Guid? mediaFileId = null)
    {
        ...
        var nEntityType = MasterDataStringSearch.NormalizeForContains(entityType);
        var nCollection = MasterDataStringSearch.NormalizeForContains(collection);
        return query.WhereIf(nf != null, e => (e.EntityFile.EntityType != null && e.EntityFile.EntityType.ToLower().Contains(nf!)) || (e.EntityFile.Collection != null && e.EntityFile.Collection.ToLower().Contains(nf!))).WhereIf(nEntityType != null, e => e.EntityFile.EntityType != null && e.EntityFile.EntityType.ToLower().Contains(nEntityType!)).WhereIf(entityId.HasValue, e => e.EntityFile.EntityId == entityId).WhereIf(nCollection != null, e => e.EntityFile.Collection != null && e.EntityFile.Collection.ToLower().Contains(nCollection!)).WhereIf(sortOrderMin.HasValue, e => e.EntityFile.SortOrder >= sortOrderMin!.Value).WhereIf(sortOrderMax.HasValue, e => e.EntityFile.SortOrder <= sortOrderMax!.Value).WhereIf(isPrimary.HasValue, e => e.EntityFile.IsPrimary == isPrimary).WhereIf(mediaFileId != null && mediaFileId != Guid.Empty, e => e.MediaFile != null && e.MediaFile.Id == mediaFileId);
    }
    ...
    protected virtual IQueryable<EntityFile> ApplyFilter(IQueryable<EntityFile> query, string? filterText = null, string? entityType = null, Guid? entityId = null, string? collection = null, int? sortOrderMin = null, int? sortOrderMax = null, bool? isPrimary = null)
    {
        ...
        var nEntityType = MasterDataStringSearch.NormalizeForContains(entityType);
        var nCollection = MasterDataStringSearch.NormalizeForContains(collection);
        return query.WhereIf(nf != null, e => (e.EntityType != null && e.EntityType.ToLower().Contains(nf!)) || (e.Collection != null && e.Collection.ToLower().Contains(nf!))).WhereIf(nEntityType != null, e => e.EntityType != null && e.EntityType.ToLower().Contains(nEntityType!)).WhereIf(entityId.HasValue, e => e.EntityId == entityId).WhereIf(nCollection != null, e => e.Collection != null && e.Collection.ToLower().Contains(nCollection!)).WhereIf(sortOrderMin.HasValue, e => e.SortOrder >= sortOrderMin!.Value).WhereIf(sortOrderMax.HasValue, e => e.SortOrder <= sortOrderMax!.Value).WhereIf(isPrimary.HasValue, e => e.IsPrimary == isPrimary);
    }
}