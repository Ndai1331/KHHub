...
abp.modals.jobFavoriteCreate = function () {
    var initModal = function (publicApi, args) {
        ...
        publicApi.onOpen(function () {
            $('#JobFavorite_JobId').select2({
                dropdownParent: $('#JobFavoriteCreateModal'),
                ajax: {
                    url: abp.appPath + 'api/masterdata/job-favorites/job-lookup',
                    type: 'GET',
