...
abp.modals.placeViewCreate = function () {
    var initModal = function (publicApi, args) {
        ...
        publicApi.onOpen(function () {
            $('#PlaceView_PlaceId').select2({
                dropdownParent: $('#PlaceViewCreateModal'),
                ajax: {
                    url: abp.appPath + 'api/masterdata/place-views/place-lookup',
                    type: 'GET',
