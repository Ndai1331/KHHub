...
abp.modals.placeFavoriteCreate = function () {
    var initModal = function (publicApi, args) {
        ...
        publicApi.onOpen(function () {
            $('#PlaceFavorite_PlaceId').select2({
                dropdownParent: $('#PlaceFavoriteCreateModal'),
                ajax: {
                    url: abp.appPath + 'api/masterdata/place-favorites/place-lookup',
                    type: 'GET',
