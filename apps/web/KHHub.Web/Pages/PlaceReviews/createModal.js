...
abp.modals.placeReviewCreate = function () {
    var initModal = function (publicApi, args) {
        ...
        publicApi.onOpen(function () {
            $('#PlaceReview_PlaceId').select2({
                dropdownParent: $('#PlaceReviewCreateModal'),
                ajax: {
                    url: abp.appPath + 'api/masterdata/place-reviews/place-lookup',
                    type: 'GET',
