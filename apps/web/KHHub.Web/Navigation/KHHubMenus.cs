...
public class KHHubMenus
{
    ...
    public const string PlacesGroup = Prefix + ".PlacesGroup";
    public const string MediaFilesGroup = Prefix + ".MediaFilesGroup";
    ...
    public const string JobsGroup = Prefix + ".JobsGroup";
